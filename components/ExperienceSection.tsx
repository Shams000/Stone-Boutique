...
const ExperienceSection = () => {
  ...
  return (
    <section className="w-full py-0 gallery h-[100vh] xl:w-[100%]  min-h-[1160px] md:min-h-[960px] relative overflow-hidden bg-gray-100">
      ...
      <div className="absolute gallery1 pl-[20px] md:pl-[45px] pt-[60px] lg:pt-[120px] h-full  xl:h-full md:min-h-[750px] w-[372px] flex flex-col items-start z-50 md:left-[40px] xl:left-[130px] lxl:left-[330px] text-left">
