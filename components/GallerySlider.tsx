...
const GallerySlider = () => {
  ...
  return (
    <section className="gallery w-full lg:w-[100%] xl:h-[100vh] md:min-h-[1100px] relative justify-center items-center md:pt-[60px] md:pb-[60px] 2xl:pt-[60px] 2xl:pb-[60px] ">
      ...
      <div className="absolute left-0 min-h-[760px] md:left-[230px] top-1/2 bottom-1/2 gap-56 transform -translate-y-1/2 flex flex-col md:justify-between h-full gallery w-[95px] md:w-[140px] pt-[220px] md:pt-[150px] items-center z-10">
